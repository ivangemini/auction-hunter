...
import { CommercialLotSelectionAuctionScene } from './scenes/CommercialLotSelectionAuctionScene';
...
export const gameConfig: Phaser.Types.Core.GameConfig = {
  ...
  scene: [OnboardingScene, CampaignPrincipalScene, CampaignInboxScene, CampaignOptionalScene, CampaignFinaleScene, CommercialLotSelectionAuctionScene, CollectionScene, DiscoveryBoardScene, CollectorRequestBuyerMarketScene, CampaignOfficeScene],
  scale: {
