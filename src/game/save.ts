...
export function normalizeSave(value: unknown): PlayerSave {
  ...
  return {
    ...
    claimedCollectorRequests: cleanStringArray(value.claimedCollectorRequests),
...
function cleanCampaignProgress(value: unknown): CampaignProgressState {
  ...
  return {
    ...
    missionBaselineAuctionsPlayed: cleanIntegerRecord(value.missionBaselineAuctionsPlayed),
    missionBaselineAuctionsWon: cleanIntegerRecord(value.missionBaselineAuctionsWon),
