...
import { ANALYTICS_SCHEMA_VERSION, registerAnalyticsSink, trackEvent, type AnalyticsEnvelope } from './analytics';

describe('analytics envelope', () => {
  it('uses a stable schema version and page-session sequence', () => {
