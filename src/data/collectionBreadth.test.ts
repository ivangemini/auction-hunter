...
describe('collection breadth', () => {
  it('keeps twenty-eight stable unique collection goal ids', () => {
    expect(COLLECTION_SETS).toHaveLength(28);
    expect(new Set(COLLECTION_SETS.map((set) => set.id)).size).toBe(28);
  });
