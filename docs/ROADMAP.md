...
- [x] Collection-set perks unlock permanent category expertise: each claimed set adds +4 percentage points to Buyer Market pricing for its category, stacking to a +12-point cap without a save migration.
