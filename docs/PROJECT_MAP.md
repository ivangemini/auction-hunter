...
- `.github/workflows/ci.yml` — CI gates, draft/archive validation, candidate ZIP, promo/screenshots and unified submission artifacts; also uploads dedicated restoration and item-art visual-review captures without changing the Yandex submission screenshot set.
